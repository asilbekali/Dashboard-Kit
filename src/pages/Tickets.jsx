...
const Tickets = () => {
  return (
    <div className='bg-white w-[100%] h-[942px] rounded-[8px] border-[1px] border-[#DFE0EB]'>
      <div className='bg-white px-[32px] mt-[32px] pb-[48px]'>
        <h2 className='font-bold text-[19px]'>All tickets</h2>
        <div className='flex items-center justify-end gap-[32px] cursor-pointer'>
          ...
          <button className='flex items-center gap-[9px] cursor-pointer'>
